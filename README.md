...
[root@aliyun mysql]# docker run --name mysql -p 3306:3306 -v $PWD/conf:/etc/mysql/conf.d -v $PWD/logs:/logs -v $PWD/data:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=123.com -d --restart=always mysql:8
...
```bash
[root@aliyun docker]# docker run --name redis -p 6379:6379 -d --restart=always redis:7 --requirepass 123.com
